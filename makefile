all: row_test matrix_test file_io_test avg_time_test

avg_time_test: avg_time_test.o
...
avg_time_test.o: avg_time_test.c matrix.o arithmetic.o matrix.h arithmetic.h
	gcc -c avg_time_test.c
